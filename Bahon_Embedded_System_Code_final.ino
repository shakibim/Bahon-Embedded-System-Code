...
#define API_KEY "AIzaSyBWqzzJEYOzrVMaEMf6HFs29zC8-LdPmSI"
#define FIREBASE_PROJECT_ID "bahon-71454"
...
void setupFirebase() {
  ...
  config.database_url = "https://xxxxxxxxx-default-rtdb.firebaseio.com";
